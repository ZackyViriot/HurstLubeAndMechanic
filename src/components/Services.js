...
const services = [
  ...
  {
    title: 'A/C & Heating',
    description: 'Complete climate control system service and repairs.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Complete transmission fluid change and system flush service.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Brake Flush',
    description: 'Complete brake fluid flush and system maintenance.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Brakes & Rotors',
    description: 'Complete brake system service including pad and rotor replacement.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Complete cooling system flush and maintenance service.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Quality tire sales and installation services.',
    icon: (
      <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
