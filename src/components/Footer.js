...
const Footer = () => {
  ...
  return (
    <footer className="bg-white relative" role="contentinfo" aria-label="Site footer">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-gray-600">
              ...
              <li>
                <span className="font-medium">Saturday:</span> 8:00 AM - 5:00 PM
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-4 text-sm text-gray-600">
              <p className="font-medium">Family Owned & Operated</p>
              <p className="mt-1">Fleet Accounts Available for Business</p>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm sm:text-base text-gray-600">
            © {currentYear} Hurst Lube & Mechanic. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
